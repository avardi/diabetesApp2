...
//            SendEmail(pdfFolder, myFile.getName());
    ...
    private static void addTitlePage(Document document, String PatientName)
 ...
 //       document.newPage();
    ...
    private static void createTable( Paragraph p ,DiabetesDbHelper dbHelp)
        ...
        c1 = new PdfPCell(new Phrase("Time", f));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        c1.setBackgroundColor(Bcolor);
        table.addCell(c1);

        c1 = new PdfPCell(new Phrase("Sugar",f));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        c1.setBackgroundColor(Bcolor);
        table.addCell(c1);

        c1 = new PdfPCell(new Phrase("Carbo",f));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        c1.setBackgroundColor(Bcolor);
        table.addCell(c1);

        c1 = new PdfPCell(new Phrase("Bolus", f));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        c1.setBackgroundColor(Bcolor);
        table.addCell(c1);

        c1 = new PdfPCell(new Phrase("Comment",f));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        c1.setBackgroundColor(Bcolor);
        table.addCell(c1);
        ...
        try
        {
            ...
            p.add(new Paragraph(
                    "This document was generated automatically by DiabetesApp.",
                    redFont));
